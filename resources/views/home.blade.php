  ...
  <main class="flex-shrink-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
      <div class="container px-5">
        <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">HMIT Telkom University
            Jakarta</span></a>
          ...
          <div class="col-xxl-5">
            ...
            <div class="text-center text-xxl-start">
              <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                <div class="text-uppercase">Solidarity in Technology</div>
              </div>
              <div class="fs-3 fw-light text-muted">Telkom University Jakarta</div>
              <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Himpunan S1 Teknologi
                  Informasi</span></h1>
              <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{ url('/anggota/struktur') }}">Struktur
                  Organisasi</a>
                <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="{{ url('/anggota/proker') }}">Program Kerja</a>
              </div>
            </div>
          </div>
          <div class="col-xxl-7">
        ...
        <div class="row gx-5 justify-content-center">
          <div class="col-xxl-8">
            <div class="text-center my-5">
              ...
              <p class="lead fw-light mb-4">Himpunan S1 Teknologi Informasi (HMIT) Telkom University Jakarta</p>
              <p class="text-muted">HMIT adalah sebuah organisasi kemahasiswaan yang nantinya akan menjadi wadah
                aktualisasi mahasiswa untuk memaksimalkan potensi minat dan bakat mahasiswa, serta menjadi motor
                penggerak yang akan merealisasikan tri dharma perguruan tinggi yang akan bergerak sesuai dengan aturan
                dan hal kultural di S1 Teknologi Informasi Telkom University Jakarta. </p>
              <div class="d-flex justify-content-center fs-2 gap-4">
                <a class="text-gradient" href="https://instagram.com/hmit.teluj/" target="_blank" rel="nofollow"><i
  ...
  <footer class="bg-white py-4 mt-auto">
    <div class="container px-5">
      <div class="row align-items-center justify-content-between flex-column flex-sm-row">
        <div class="col-auto">
          <div class="small m-0">Copyright &copy; HMIT Telkom University Jakarta 2023</div>
        </div>
        <div class="col-auto">
