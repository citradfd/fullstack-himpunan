            ...
            <section class="py-5">
                <div class="container px-5 mb-5">
                    <div class="text-center mb-5">
                        <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">Struktur Organisasi</span></h1>
                    </div>
                    <div class="row gx-5 justify-content-center">
                    <img class="profile-img" src="{{ asset('images/struktur.jpg') }}" alt="..." />
            ...
            <section class="py-5 bg-gradient-primary-to-secondary text-white">
                <div class="container px-5 my-5">
                    <div class="text-center">
                        ...
                        <a class="btn btn-outline-light btn-lg px-5 py-3 fs-6 fw-bolder" href="https://instagram.com/hmit.teluj/">Contact Us</a>
                    </div>
                </div>
            </section>
        </main>
